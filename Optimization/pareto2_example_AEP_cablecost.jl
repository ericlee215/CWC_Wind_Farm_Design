...
fopt, xopt, info = generate_2D_pareto_points(design_variables_param, pareto_param, opt_algorithm_param, non_pareto_con!=non_pareto_con!, non_pareto_con_tolerance=non_pareto_con_tolerance)
